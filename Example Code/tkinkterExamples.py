...
window.configure(background='#202C4F')
...
radiobuttonVariableName = StringVar()   # referenced in out tkinter code. Note that these are ONLY variables used to RETURN
checkbuttonVariableName = StringVar()   # data. Variables used to store data (e.g. the lists which store data for the 
                                        # Dropdown Menu Entry do not need to be declared here.
...
labelTitle = Label(window, 
                   ...
                   width=20, 
                   font=("bold", 20),
                   bg='#202C4F')                        # This is a label which will display text to the user. It does
labelTitle.grid(row=0, column=0, columnspan=2)          # not take any form of data entry.
...
labelSimpleTextEntry = Label(window, 
                             ...
                             width=20, 
                             font=("bold", 10),
                             bg='#202C4F')                          # This will take simple StringVar or IntVar data entry
...
labelDropDownEntry = Label(window, 
                           ...
                           width=20, 
                           font=("bold", 10),
                           bg='#202C4F')                                            # This allows for the user to select one option from
...
droplist.config(width=20, bg='#202C4F')                   
...
labelRadiobuttonEntry = Label(window, 
                              ...
                              width=20, 
                              font=("bold", 10),
                              bg='#202C4F')                 # This allows for the user to select only
...
Checkbutton(window, 
            text="Option 1", 
            bg='#202C4F',
            variable=checkbuttonVariableName).grid(row=5, column=1)  
Checkbutton(window, 
            text="Option 2", 
            bg='#202C4F',
            variable=checkbuttonVariableName).grid(row=5, column=2)   

# ***** Command Button ***** #

Button(window, text='Command to Execute', width=20, bg='brown', fg='white', command=doNothing).grid(row=6, column=0, columnspan=2)
