    ...
    def createDoc():
        ...
        def getCombobox():
            ...
            if result == 1: #Attend RE Tests
                ...
                def enterData():
                    enteredCorrOrigin = entryCorrOrigin.get()
                    tempWindow2.destroy()
                    return enteredCorrOrigin
                ...
                spacerLabel = Label(tempWindow2, 
                                    text=" ",
                                    width=4)
                spacerLabel.grid(row=1, column=0, columnspan=9)

                labelCorrOrigin = Label(tempWindow2, 
                                    text="Correspondence Origin: ",
                                    font=("corbel bold", 10))
                labelCorrOrigin.grid(row=2, column=1)
                entryCorrOrigin = Entry(tempWindow2, 
                                    textvar=corrOrigin)
                entryCorrOrigin.grid(row=2, column=3, columnspan=3, sticky=E+W)

                spacerLabel = Label(tempWindow2, 
                                    text=" ",
                                    width=4)
                spacerLabel.grid(row=3, column=0, columnspan=9)

                saveButton = Button(tempWindow2, 
                                        text='Create', 
                                        bg='darkblue', 
                                        fg='white', 
                                        command=enterData).grid(row=2, column=7)
        ...
        if templateType == 1:
            with MailMerge(r'.\templates\attendReTests.docx') as document:
                ...
                document.write(r'.\documentOutput\TESTattendReTests.docx')
            ...
            with MailMerge(r'.\templates\attendReCorrespondence.docx') as document:
                ...
                document.merge(Title=patientTitle,
                           ...
                           Staff_First_Initial=userFirstInitial,
                           Staff_Surname=userSurname,
                           Correspondence_Origin=enteredCorrOrigin)

                document.write(r'.\documentOutput\TESTattendReCorrespondence.docx')
