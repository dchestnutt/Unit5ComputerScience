...
labelUsername = Label(tempWindow, 
                        ...
                        bg="white",
                        padx=5)                                   
labelUsername.grid(row=6, column=0, sticky=E)
entryUsername = Entry(tempWindow, textvar=username)            
entryUsername.grid(row=6, column=1, sticky=W)
...
labelPassword = Label(tempWindow, 
                        ...
                        bg="white",
                        padx=5)                                  
labelPassword.grid(row=7, column=0, sticky=E)
entryPassword = Entry(tempWindow, textvar=password, show = '•') 
entryPassword.grid(row=7, column=1, sticky=W)

spacerLabel = Label(tempWindow, text=" ", bg="white")
spacerLabel.grid(row=8, column=0, columnspan=2)

logedIn = Button(tempWindow, text='Log-In', bg='darkblue', fg='white', command=checkUser).grid(row=9, column=0, columnspan=2)
