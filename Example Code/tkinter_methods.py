...
labelTitle = Label(win, text="Registration Form", width=20, font=("bold", 20))
labelTitle.place(x=450, y=10)

# This will give the option of picking from a drop-down list of countries
...
# These each define a label and entry form for a string value
